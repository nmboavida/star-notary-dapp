...
it('can add the star name and star symbol properly', async() => {
    ...
    await instance.createStar("Test Star", tokenId, { from: owner })
...
it('lets a user transfer a star', async() => {
    ...
    await instance.createStar("Star", tokenId, { from: owner });
...
it('lookUptokenIdToStarInfo test', async() => {
    ...
    await instance.createStar("Starz", tokenId, { from: owner });

    const name = await instance.lookUptokenIdToStarInfo(tokenId, { from: owner });

    assert.equal(name, "Starz")
});